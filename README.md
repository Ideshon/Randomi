...
Сделано на [Python text randomizer](https://github.com/ivanenko/python_text_randomizer)

> [!IMPORTANT]
> У меня нулевые навыки программирования. Все, что связано с кодом объясняйте мне очень подробно.
